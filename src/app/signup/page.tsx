...
export default function SignupPage() {
  ...
  >
    <svg
      ...
      viewBox="0 0 24 24"
    >
      <path d="M12 2C6.48 2 2 6.48 2...z" />
    </svg>
        ...
        >
          ...
          <div className="mt-8 space-y-4">
            ...
            >
              <Link
                href="/quiz"
                className="w-full inline-flex items-center justify-center px-6 py-3 text-base font-medium bg-[var(--pp-primary)] text-white rounded-xl shadow transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--pp-primary)] focus-visible:ring-offset-2 focus-visible:shadow-lg"
            ...
            >
              <Link
                href="/landing"
                className="w-full inline-flex items-center justify-center px-6 py-3 text-base font-medium bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--pp-primary)] focus-visible:ring-offset-2"
            ...
            <div className="mt-2">
              <Link
                href="/landing"
                className="text-sm text-blue-600 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--pp-primary)] focus-visible:ring-offset-2 rounded px-1"
          ...
          <p className="mt-8 text-xs text-gray-400">
            ...
            <Link href="#" className="underline hover:text-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--pp-primary)] focus-visible:ring-offset-2">Terms of Service</Link>
            {' '}and{' '}
            <Link href="#" className="underline hover:text-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--pp-primary)] focus-visible:ring-offset-2">Privacy Policy</Link>.
          </p>
        </motion.div>
      </div>
    </div>
